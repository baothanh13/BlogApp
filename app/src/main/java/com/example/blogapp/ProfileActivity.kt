...
class ProfileActivity : AppCompatActivity() {
    ...
    private lateinit var database: DatabaseReference // Using 'database' as declared
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.addNewABlogButton.setOnClickListener { // Replace with your actual ImageButton ID!
            val intent = Intent(this, AddArticleActivity::class.java)
            startActivity(intent)
        }
        //to go to your articles page
        binding.articlesButton.setOnClickListener { // Replace with your actual ImageButton ID!
    ...
    private fun loadUserProfileData(userId: String) {
        val userReference: DatabaseReference = database.child(userId) // Using 'database' here
        //load user name
